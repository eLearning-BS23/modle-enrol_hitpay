...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_hitpay/salt',
        get_string('salt', 'enrol_hitpay'),
        get_string('salt_desc', 'enrol_hitpay'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_hitpay/clientid',
        get_string('clientid', 'enrol_hitpay'),
        get_string('clientid_desc', 'enrol_hitpay'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_hitpay/clientsecret',
        get_string('clientsecret', 'enrol_hitpay'),
        get_string('clientsecret_desc', 'enrol_hitpay'), '', PARAM_TEXT));
