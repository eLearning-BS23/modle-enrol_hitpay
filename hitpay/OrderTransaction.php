...
class OrderTransaction {
    ...
    {
        $sql = "select * from {enrol_hitpay} WHERE txn_id ='" . $tran_id . "'";
        return $sql;
    }
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        $sql = "INSERT INTO {enrol_hitpay} (userid, courseid, instanceid, payment_status, txn_id)
    ...
    public function logTransactionQuery($post_data)
    {
        ...
        $sql = "INSERT INTO {enrol_hitpay_log} (userid, courseid, instanceid, payment_status, txn_id)
                                    VALUES ($userid,$courseid, $instance_id, 'Pending', '$transaction_id')";
        return $sql;
    }
    ...
    public function updateTransactionQuery($tran_id, $type = 'Success')
    {
        ...
        $sql = "UPDATE {enrol_hitpay} SET payment_status='$type' WHERE txn_id ='$tran_id'";
